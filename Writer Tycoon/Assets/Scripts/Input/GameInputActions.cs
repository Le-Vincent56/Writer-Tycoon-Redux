...
namespace GhostWriter.Input
{
    ...
    ""controlSchemes"": []
        ...
        ~@GameInputActions()
        {
            ...
            UnityEngine.Debug.Assert(!m_DevelopmentTools.enabled, "This will cause a leak and performance issues, GameInputActions.DevelopmentTools.Disable() has not been called.");
        }
